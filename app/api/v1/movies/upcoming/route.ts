 ...
 *
 * Mengembalikan daftar movie yang akan datang.
 *
...
export const GET = withApiHandler(async (req: Request) => {
  ...
  const result = await moviesService.getUpcoming(page, limit)
  return paginatedResponse(result.items, result.total, result.page, result.limit, 'Upcoming movies fetched successfully')
})
